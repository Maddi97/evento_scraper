...
class Address(BaseModel):
    ...
    street: Optional[str] = Field(description="Name der Strasse an dem das Event stattfindet")
    city: Optional[str] = Field(description="Name der Stadt")
    streetNumber: Optional[str] = Field(description="Hausnummer in der Strasse in der das Event stattfindet")
...
class EventSchema(BaseModel):
    ...
    link: Optional[str] = Field(description="Die Url unter der man die Eventseite erreicht")
    ...
    frequency: Optional[Union[dict, str, None]] = Field(description="Die Häufigkeit mit der das Event stattfindet")
    address: Optional[Address] = Field(description="Die Adress des Events")
    times: Optional[Times] = Field(description="Die Uhrzeiten an denen das Event stattfindet")
